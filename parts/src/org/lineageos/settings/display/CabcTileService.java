...
public class CabcTileService extends TileService {
    ...
    public void onCreate() {
        ...
        CabcModes = context.getResources().getStringArray(R.array.amoled_cabc_modes);
        CabcValues = context.getResources().getStringArray(R.array.amoled_cabc_values);
    }

    private void updateCurrentCabcMode() {
        currentCabcMode = Arrays.asList(CabcValues).indexOf(SystemProperties.get(AmoledFeaturesPreferenceFragment.CABC_PROP, "0"));
    }
    ...
    public void onClick() {
        ...
        SystemProperties.set(AmoledFeaturesPreferenceFragment.CABC_PROP, CabcValues[currentCabcMode]);
        updateCabcTile();
    }
}
