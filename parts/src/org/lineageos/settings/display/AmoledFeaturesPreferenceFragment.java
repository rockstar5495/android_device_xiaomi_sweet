...
public class AmoledFeaturesPreferenceFragment extends PreferenceFragment
        implements Preference.OnPreferenceChangeListener {

    public static final String HBM_PROP = "persist.amoled.hbm_mode";
    public static final String CABC_PROP = "persist.amoled.cabc_mode";
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        addPreferencesFromResource(R.xml.amoled_features_settings);
